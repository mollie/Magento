...
class Mollie_Mpm_Block_Adminhtml_Sales_Creditmemo_PaymentFeeTest extends Mollie_Mpm_Test_TestHelpers_TestCase
{
    public function testAddsTheTotal()
    {
        /** @var Mollie_Mpm_Block_Adminhtml_Sales_Creditmemo_PaymentFee $block */
        $block = Mage::app()->getLayout()->createBlock('mpm/adminhtml_sales_creditmemo_paymentFee');
